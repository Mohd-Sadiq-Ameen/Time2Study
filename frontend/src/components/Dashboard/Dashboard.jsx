...
export default function Dashboard() {
  ...
  const navItems = [
    ...
    { id: "study", name: "Start Study", icon: "🎥" },
    { id: "sessions", name: "My Sessions", icon: "⏱️" },
              ...
              <div className="p-6">
                ...
                {activeItem === "settings" && (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-slate-500">Configure your preferences</p>
                  </div>
                )}
              </div>
            </div>
